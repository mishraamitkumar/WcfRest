    ...
    {       
        ...
        public async Task<List<Student>> getstudents()
        {
            ...
            try
            {
                ...
                //return StudentCollection.ToJson();//.ToJson();

              List<Student>  ls = StudentCollection.Select(a => new Student {
                    //Id = a["_id"].ToString(),
                    Name = a["Name"].ToString(),
                    Address = a["Address"].ToString(),
                    Class = a["Class"].ToString(),
                    RollNo = a["RollNo"].ToString()
                }).ToList();
        ...
        public async void insertStudent(Student std)
        {
            //throw new NotImplementedException();
